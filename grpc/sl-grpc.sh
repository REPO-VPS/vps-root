...
#
wget -q -O /usr/local/bin/geosite.dat "https://raw.githubusercontent.com/kali-linux-ir/vps-root/main/grpc/geosite.dat"
wget -q -O /usr/local/bin/geoip.dat "https://raw.githubusercontent.com/kali-linux-ir/vps-root/main/grpc/geoip.dat"
...
wget -O sl-addgrpc "https://raw.githubusercontent.com/kali-linux-ir/vps-root/main/grpc/sl-addgrpc.sh"
chmod +x sl-addgrpc
chmod +x sl-delgrpc
